...
function HoldingsStack() {
  return (
    <Stack.Navigator screenOptions={{ headerShown: true, ...screenOptions }}>
      <Stack.Screen name="HoldingsList" component={HoldingsScreen} options={{ title: 'Holdings' }} />
      <Stack.Screen name="HoldingDetail" component={HoldingDetailScreen} options={{ title: 'Holding' }} />
  ...
  return (
    <Tab.Navigator
      ...
      >
        ...
        <Tab.Screen name="Holdings" component={HoldingsStack} options={{ title: 'Holdings', headerShown: false }} />
